...
std::vector<std::tuple<std::string, std::string, bool, long long, std::string>> performPing(const std::map<std::string, std::string>& hosts) {
    ...
    std::vector<std::future<std::tuple<std::string, std::string, bool, long long, std::string>>> futures;
    ...
    // 收集所有主机的结果
    std::vector<std::tuple<std::string, std::string, bool, long long, std::string>> allResults;
